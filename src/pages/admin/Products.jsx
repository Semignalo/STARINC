...
export default function Products() {
    ...
    const handleEdit = (product) => {
        ...
        setFormData({
            ...
            featureImage: product.feature_image_url || product.feature_image || '',
            featureTitle: product.feature_title || '',
            featureText: product.feature_text || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apiData = {
                ...
                feature_image: formData.featureImage || null,
                feature_title: formData.featureTitle || null,
                feature_text: formData.featureText || null,
